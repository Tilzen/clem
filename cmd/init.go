...
const claudeSharedJiraTemplate = `# CLAUDE.local.md — runtime contract for all {{project}} agents
# Generated by clem from CLAUDE.shared.md + CLAUDE.<agentkey>.md. Do not hand-edit this file.
...
via the **jira-mcp** tools (mcp-atlassian). Install with: ` + "`pipx install mcp-atlassian`" + `.
